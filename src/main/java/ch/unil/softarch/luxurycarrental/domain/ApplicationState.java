...
public class ApplicationState {
    ...
    private void populateApplicationState() {
        ...
        Car car1 = new Car(UUID.randomUUID(), "VD12345", sedan, 100.0, 300.0, CarStatus.AVAILABLE,
                "https://example.com/camry.jpg", LocalDate.now(), LocalDate.now(), "VIN123456", "White", LocalDate.now().plusYears(1));
        cars.put(car1.getId(), car1);

        Car car2 = new Car(UUID.randomUUID(), "VD67890", suv, 200.0, 500.0, CarStatus.AVAILABLE,
                "https://example.com/x5.jpg", LocalDate.now(), LocalDate.now(), "VIN654321", "Black", LocalDate.now().plusYears(1));
